...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "MyDataDCAppShell", dependencies: ["MyDataDCCore", "CareerHQCore", "CareerHQUI", "NetSphereCore"]),
        ...
        .testTarget(name: "MyDataDCAppShellTests", dependencies: ["MyDataDCAppShell", "MyDataDCCore", "NetSphereCore"]),
